...
**Repository:** [https://github.com/Krishna4/inbox-hero-IIT](https://github.com/Krishna4/inbox-hero-IIT)  
**Primary Model:** Qwen2.5:1.5b via Ollama (Local)  
...
|:---|:---|:---:|:---|:---|:---|
| **R1** | **Triage** | **A** | Assigns every inbox message exactly one disposition (`reply`, `archive`, `defer`, `delegate`, `escalate`). 33 rule-handled messages consume zero LLM tokens; remainder are triaged via Qwen2.5:1.5b (Ollama) in batches of 10. | `python demo.py --cap R1` | `decisions.json`, `trace.jsonl` (cap=R1) |
